...
if ($result2['major'] == "วิศวกรรมซอฟแวร์") { ?>
  <div class="col-lg-4 col-md-6 portfolio-item filter-4">
    ...
    <div class="portfolio-info">
      ...
      <a href="../controller/controller_Delete.php?id=<?= $result2['id'] ?>" onclick="return confirm('คุณต้องการจะลบข้อมูลนักศึกษาคนนี้ออกจากระบบหรือไม่?')" class="details-link" title="More Details"><i class="bi bi-trash"></i></a>
    </div>
  </div>
